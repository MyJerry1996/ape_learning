...
# To determine whether combining APE Loss with Triplet Loss during training
_C.MODEL.IF_TRIPLET = 'no'
# If train with label smooth, options: 'on', 'off'
_C.MODEL.IF_LABELSMOOTH = 'on'
# To determine whether adjusting the learning rate with a complex way
_C.MODEL.ADJUST_LR = 'off'
...
_C.DATASETS.ROOT_DIR = ('/workspace/dataset')
